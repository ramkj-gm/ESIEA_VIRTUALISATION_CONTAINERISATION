...
INSERT INTO `products` (`name`, `description`, `price`, `has_available_quantity`, `quantity`, `available_quantity`, `image_path`, `deleted`) VALUES
...
INSERT INTO `rentals` (`client_id`, `article_id`, `rental_date`, `return_date`, `rented`, `shipping_address`) VALUES
